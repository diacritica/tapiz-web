...
date: 2019-05-19T16:00:00+02:00
---
...
- **Habilidades**: son un conjunto de habilidades básicas que todos los personajes tienen. Éstos indican cuán fuerte, inteligente y en general capaces son. Cada habilidad dispone de una **valor** y un **modificador**. *Fuerza*, por ejemplo, indica la fuerza física de un personaje mientras que *Carisma* indica su habilidad para influenciar a otros socialmente. Una habilidad constituirá la **habilidad principal** del personaje, aquella que ha sido más empleada o desarrollada.
- **Atributos**: son cualidades específicas de un PJ y están siempre bajo el amparo de una habilidad. Por ejemplo, *Percepción* hace referencia a la capacidad del PJ de darse de cuenta de algo que sucede a su alrededor mientras que *Persuasión* indica lo fácil o díficil que es para ese PJ influenciar o intimidad a otra persona o criatura. Los **atributos** pueden evolucionar y mejorar con el tiempo y representan en parte el incremento de poder del PJ con el tiempo.
- **Rasgos**: son propiedades muy particulares del PJ. Representan aspectos muy personales de las capacidades del PJ y pueden resultar determinantes en diferentes situaciones. Los rasgos pueden ser básicos (son palabras o frases cortas que describen detalles interesantes acerca de un personaje) o avanzados (formulaciones más elaboradas sobre el potencial del PJ). Por ejemplo, *leal a la reina* es un rasgo básico que podría entrar en juego en un momento de persuasión ante unos guardias del reino, mientras que *Infravisión a 30m*, un rasgo avanzado, permite que el PJ pueda manejarse con soltura en entornos de oscuridad.
...
![Level up](/tapiz/images/level-up.jpg)
...
...
#### Tiradas Incrementales
...
#### Retos Incrementales
...
#### Tiradas Combinadas
...
#### Tiradas Dependientes/Aumentadas/Lastradas
...
#### Acciones
...
...
##### Ataques a distancia
...
##### Ataques de contacto o toque
...
##### Ataques de desiquilibrio
...
##### Ataques de agarre o bloqueo
...
##### Concentración
...
...
##### Intimidar a alguien
...
##### Persuadir o encandilar a alguien
...
##### Aterrorizar a alguien
...
##### Primeros auxilios
...
##### Ayudar o perjudicar a alguien
...
##### Buscar trampas ocultas
...
##### Esconderse o escabullirse
...
##### Robar los bolsillos
...
...
...
#### Eliminar, contrarrestar o curar Consecuencias
...
### Avances
...
#### Subir de Nivel
...
#### Personajes Multi-clase
...
### Jugar a niveles altos
...
#### Escala
...
#### Constructos
...
#### Seguidores, compañeros y mercenarios
...
##### Seguidores
...
##### Compañeros
...
...
##### Tirada de forrajeo o aprovisionamiento
...
### Tesoro y Riquezas
...
#### Fama y Fortuna
